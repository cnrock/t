...
clear
echo ------------------------------------------
echo        CentOS7 openssh升级到8.8p1--online
echo        配合最新openssl-1.1.1m--2022-02-11
echo            By feichai
echo            Mod cnrock
echo         生产环境使用前请做好测试
echo ------------------------------------------
...
clear
echo 下载关键包
wget -c --no-check-certificate https://www.openssl.org/source/openssl-1.1.1m.tar.gz
#wget -c  https://cdn.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-8.8p1.tar.gz
wget -4 -c --no-check-certificate https://mirrors.mit.edu/pub/OpenBSD/OpenSSH/portable/openssh-8.8p1.tar.gz
